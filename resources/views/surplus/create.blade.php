                        ...
                        <div class="container px-5 py-24 mx-auto">
                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  <label for="start_time" class="leading-7 text-sm text-gray-600">Available Pickup Time</label>
                              ...
                              <div class="p-2 w-1/2">
                                <button class="text-white bg-orange-300 border-0 py-2 px-8 focus:outline-none hover:bg-orange-400 rounded text-lg" style="padding-left: 32px; padding-right: 32px;">Register</button>
