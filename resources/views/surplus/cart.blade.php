        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          @else
                  ...
                  <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                      ...
                      <div class="flex">
                        ...
                        <button class="flex ml-auto mt-10 text-white bg-red-400 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"><a href="/products/{{ $product->id }}">{{ __('Remove from Your Cart') }}</a></button>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div id="payment-form" style="display: none;">
              ...
              <br>
              <button type="submit" class="text-white bg-orange-400 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded" onclick="confirmPurchase(event)">
                Purchase
              </button>
