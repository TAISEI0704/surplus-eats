    ...
    <div class="container px-5 py-24 mx-auto">
      ...
      <div class="-my-8 divide-y-2 divide-gray-100">
        <div class="py-8 flex flex-wrap md:flex-nowrap">
          ...
          @else
          <a href="/read/{{$notification->id}}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg" style="padding-left: 32px; padding-right: 32px;">
          Unread
          </a>
          @endif
          </div>
